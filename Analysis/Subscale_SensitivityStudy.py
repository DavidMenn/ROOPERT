...
index=0
test_points=[0,.0001,-.0001]
for temp in test_points:
    if index==0:
        twlisttemp = twlist+temp
...
if True:
    ...
    plt.figure()
    plt.plot(xlistflipped,hglistmat[0,:] , 'g', label=f"Gas Side Wall Temp, K, tw error={round(test_points[0],4)*1000} mm")
    plt.plot(xlistflipped,hglistmat[1,:] , 'g--', label=f"Gas Side Wall Temp, K, tw error={round(test_points[1],4)*1000} mm")
    plt.plot(xlistflipped, hglistmat[2,:] , 'g:', label=f"Gas Side Wall Temp, K, tw error={round(test_points[2],4)*1000} mm")
    ...
    plt.figure()
    plt.plot(xlistflipped,FOSlistmat[0,:] , 'b', label=f"Gas Side Wall Temp, K, tw error={round(test_points[0],4)*1000} mm")
    plt.plot(xlistflipped,FOSlistmat[1,:] , 'b--', label=f"Gas Side Wall Temp, K, tw error={round(test_points[1],4)*1000} mm")
    plt.plot(xlistflipped, FOSlistmat[2,:] , 'b:', label=f"Gas Side Wall Temp, K, tw error={round(test_points[2],4)*1000} mm")
    plt.xlabel("Axial Position [m From Injector Face]")
    plt.ylabel("hFOS")
    plt.legend()
    plt.title(title)
    ...
    plt.figure()
    plt.plot(xlistflipped,Twglistmat[0,:] , 'g', label=f"Gas Side Wall Temp, K, tw error={round(test_points[0],4)*1000} mm")
    ...
    plt.plot(xlistflipped,Twclistmat[1,:] , 'r--', label=f"CoolantSide Wall Temp, K,tw error={round(test_points[1],4)*1000} mm") # row=0, column=0
    ...
    plt.plot(xlistflipped,Tclistmat[2,:] , 'b:', label=f"Coolant Temp, K, tw error={round(test_points[2],4)*1000} mm") # 
    plt.xlabel("Axial Position [m From Injector Face]")
