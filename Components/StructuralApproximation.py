...
def mass_approx(Pc,dp, OD, rho_f,rho_ox, thrust, isp, burntime, rm):
    ...
    newheight=(currentheight-(fuelheight+oxheightcurrent+presheightcurrent))*OD/8+(heightox+heightfuel+heightpres);
